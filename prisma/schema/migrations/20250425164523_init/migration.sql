...
CREATE TABLE "games" (
    ...
    "statusId" INTEGER NOT NULL DEFAULT 1,
    "isPlaces" BOOLEAN NOT NULL DEFAULT true,
    "places" INTEGER,
...
-- AddForeignKey
ALTER TABLE "questions" ADD CONSTRAINT "questions_statusId_fkey" FOREIGN KEY ("statusId") REFERENCES "statuses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
